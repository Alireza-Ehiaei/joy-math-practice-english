...
// Base sizes for phones
    const baseContainerWidth = 280.0;
...
// Scale factor for tablets
    double scaleFactor = isTablet ? (screenWidth / 850) : 1.0;

// Scaled sizes
    final containerWidth = baseContainerWidth * scaleFactor;
    final fontSizeText = baseFontSizeText * scaleFactor;
        ...
        child: RichText(
          text: TextSpan(
            children: <TextSpan>[
              ...
              TextSpan(
                text:
                "📌 Break numbers into smaller, more manageable parts for easier mental calculation. "
              ...
              TextSpan(
                text:
                "📌 Round numbers to the nearest ten, hundred, or thousand to simplify the addition. Remember to adjust the final result.\n\n"
              ...
              TextSpan(
                text:
                "📌 When adding multiple numbers, look for pairs or groups that are easy to add together. Rearrange the numbers to create simpler sums.\n\n"
              ...
              TextSpan(
                text:
                "📌 Technique: If all numbers in a sum end with zeros, ignore an equal number of zeros from each number and add the remaining digits. Then, restore the ignored zeros to the end of the answer.\n\n"
      ...
      body: Container(
        ...
        child: RichText(
          text: TextSpan(
            children: <TextSpan>[
              TextSpan(
                text: 'Mental subtraction tricks\n\n ',
                style: TextStyle(
                  fontWeight: FontWeight.bold,
                  color: Colors.pink,
                  fontSize: isTablet ? 36 : 28,
              ...
              TextSpan(
                text: 'Subtraction using addition\n ',
                style: TextStyle(
                  fontWeight: FontWeight.bold,
              ...
              TextSpan(
                text:
                "📌 Turn subtraction into an addition problem. Ask: \"What number, when added to the smaller number, equals the larger number?\"\n\n"
              ...
              TextSpan(
                text:
                "📌 Break the subtraction into smaller, more manageable parts, then combine the results.\n\n"
              ...
              TextSpan(
                text: 'Round *Before* You Subtract!\n ',
                style: TextStyle(
                  fontWeight: FontWeight.bold,
                  color: const Color.fromARGB(255, 220, 29, 4),
                  fontSize: isTablet ? 32 : 26,
              ...
              TextSpan(
                text:
                "📌 Round numbers before subtracting, then adjust the result by adding back what you subtracted (or subtracting what you added) to round.\n\n"
              ...
              TextSpan(
                text:
                "📌 If both numbers end in zeros, remove the same number of zeros, subtract, then add the zeros back to the result.\n\n"
      ...
      body: Container(
        ...
        child: RichText(
          text: TextSpan(
            children: <TextSpan>[
              TextSpan(
                text: 'Mental multiplication tricks\n\n ',
                style: TextStyle(
                  fontWeight: FontWeight.bold,
                  color: Colors.pink,
                  fontSize: isTablet ? 36 : 28,
              ...
              TextSpan(
                ...
                style: TextStyle(fontSize: isTablet ? 30 : 25, color: Colors.black),
              ),
              TextSpan(
                text: 'Ignoring trailing zeros\n ',
                style: TextStyle(
              ...
              TextSpan(
                text: 'Multiplication in smaller parts\n ',
                style: TextStyle(
                  fontWeight: FontWeight.bold,
                  color: const Color.fromARGB(255, 220, 29, 4),
                  fontSize: isTablet ? 32 : 26,
              ...
              TextSpan(
                text: "📌 To calculate 7 x 84, mentally compute 7 x 80 and 7 x 4 separately, then add the results: 560 + 28 = 588. \n\n"
              ...
              TextSpan(
                text: 'Multiplying a number by five\n',
                style: TextStyle(
                  fontWeight: FontWeight.bold,
                  color: const Color.fromARGB(255, 220, 29, 4),
                  fontSize: isTablet ? 32 : 26,
              ...
              TextSpan(
                text: 'Rearranging Numerators in Fractional Multiplication\n',
                style: TextStyle(
                  fontWeight: FontWeight.bold,
                  color: const Color.fromARGB(255, 220, 29, 4),
                  fontSize: isTablet ? 32 : 26,
              ...
              TextSpan(
                text: "📌 Multiplying by 9 (Algebraic Method) [2]: Rewrite 9 as (10 - 1). Then distribute. For example, 17 x 9 becomes 17 x (10 - 1) = (17 x 10) - (17 x 1).\n\n"
                    "🧩 Example: 17 x 9 = 17 x (10 - 1) = (17 x 10) - (17 x 1) = 170 - 17 = 153 [2].\n\n",
                style: TextStyle(fontSize: isTablet ? 30 : 25, color: Colors.black),
              ),
              TextSpan(
                text: 'Other multiplication tricks\n',
                style: TextStyle(
                  fontWeight: FontWeight.bold,
                  color: const Color.fromARGB(255, 220, 29, 4),
                  fontSize: isTablet ? 32 : 26,
              ...
              TextSpan(
                text: " Explore More Multiplication Tricks: Search online for techniques like multiplying three-digit numbers by "
        ...
        child: RichText(
          text: TextSpan(
            children: <TextSpan>[
              ...
              TextSpan(
                text:
                "📌 Dividing a number (the dividend) by another number (the divisor) is like counting how many times you can subtract the divisor from the dividend (and subsequent remainders) until you can't subtract anymore.\n\n"
              ...
              TextSpan(
                text: 'Ignoring trailing Zeros equally and restoring them at the end\n ',
                style: TextStyle(
                  fontWeight: FontWeight.bold,
                  color: const Color.fromARGB(255, 220, 29, 4),
                  fontSize: isTablet ? 32 : 26,
              ...
              TextSpan(
                text:
                "📌 Dividing Numbers Ending in Zeros: If both the dividend and divisor end in zeros, you can ignore an equal number of trailing zeros in both numbers before dividing. There's no need to add zeros back to the result.\n\n"
              ...
              TextSpan(
                text: 'Division with subtraction\n ',
                style: TextStyle(
                  fontWeight: FontWeight.bold,
                  color: const Color.fromARGB(255, 220, 29, 4),
                  fontSize: isTablet ? 32 : 26,
              ...
              TextSpan(
                text:
                "📌 Division as Repeated Subtraction (Recap): As mentioned earlier, dividing one number (the dividend) by another (the divisor) is equivalent to repeatedly subtracting the divisor from the dividend (and subsequent results) until the remaining value is less than the divisor. This final value is the remainder.\n\n"
              ...
              TextSpan(
                text:
                "📌 Simplifying Division Before Calculating: Check if you can simplify the dividend and divisor by dividing both by a common factor before performing the division. This can make the calculation easier.\n\n"
              ...
              TextSpan(
                text: 'Division into smaller parts\n',
                style: TextStyle(
                  fontWeight: FontWeight.bold,
                  color: const Color.fromARGB(255, 220, 29, 4),
                  fontSize: isTablet ? 32 : 26,
              ...
              TextSpan(
                text:
                "📌 Dividing into Smaller Parts (Dividend): You can sometimes simplify division by breaking the dividend into a sum of numbers that are easily divisible by the divisor. \n\n"
              ...
              TextSpan(
                text: 'Division with multiplication\n',
                style: TextStyle(
                  fontWeight: FontWeight.bold,
                  color: const Color.fromARGB(255, 220, 29, 4),
                  fontSize: isTablet ? 32 : 26,
              ...
              TextSpan(
                text:
                "📌 Division as Multiplication by the Inverse: Dividing by a number is the same as multiplying by its inverse. For example, 5 divided by 0.25 (which is 25/100) is the same as 5 multiplied by 100/25, which equals 5 x 4 = 20.\n\n"
...
class _State extends State<Mental_calculation_practice_page> {
  ...
  Widget build(BuildContext context) {
    ...
    final paddedMathOper = math_oper.map((widget) {
      return Padding(
        padding: EdgeInsets.symmetric(horizontal: 5.5 * scaleFactor), // adjust padding as needed
        child: widget,
      );
    }).toList();
    ...
    (int.parse(first_number_text) < int.parse(first_number_text))) {
      ...
      Text(
        ...
        style: TextStyle(
          color: Colors.red,
          fontWeight: FontWeight.bold,
          fontSize: isTablet ? 44 : 18, // 24 for tablet, 18 for phone
        ),
      );
      Text(
        text2,
        style: TextStyle(
          color: Colors.blue,
          fontWeight: FontWeight.bold,
          fontSize: isTablet ? 42 : 16, // 22 for tablet, 16 for phone
        ),
      );
      Text(
        text3,
      ...
      if (notification_operationindex.value == 3) {
        _answer_text1 = (int.parse(first_number_text) + int.parse(second_number_text)).toString();
        final isCorrect = _answer_text1 == _controller_answer.text;
        ...
        if (isCorrect) {
          if (id == 1) {
            ...
            notificationtext.value = "Very good, your answer is correct!";
            notificationlist.value = [" $_answer_text1 "];
            notificationcolor.value = 1;
          }
        } else {
          if (id == 1) {
        ...
        _answer_text1 = (int.parse(first_number_text) - int.parse(second_number_text)).toString();
        bool isCorrect = _answer_text1 == _controller_answer.text;

        if (isCorrect) {
          notificationtext.value = (id == 1) ? text3 : "Very good, your answer is correct!";
          notificationlist.value = (id == 0) ? [" $_answer_text1"] : [];
          notificationcolor.value = 1; // green
        } else {
          notificationtext.value = (id == 1) ? text1 : text2;
          notificationlist.value = (id == 0) ? [" $_answer_text1"] : [];
          notificationcolor.value = 0; // red
        }
      }
